...
// - Sends a notification email using Resend to orukoleon94@gmail.com with replyTo set
...
export async function POST(req: Request) {
  try {
    ...
    const result = await resend.emails.send({
      from: '"Leon Oruko Portfolio" <onboarding@resend.dev>', // Resend verified email
      to: 'orukoleon94@gmail.com', // your personal inbox
      subject: '📩 New Contact from Leon Oruko Portfolio Website',
